...
export class EventFormService {
  validationMessages = {
    ...
    startTime: {
      ...
      pattern: 'Start time must be a <strong>valid time</strong> in the format <strong>H:MM AM/PM</strong>.',
    ...
    endTime: {
      ...
      pattern: 'End time must be a <strong>valid time</strong> in the format <strong>H:MM AM/PM</strong>.',
